      ...
      <div className="relative w-full overflow-hidden h-[400px] md:h-[552px] lg:h-[552px]">
        {MainProps.map((item, index) => (
          <div
            ...
            className={`absolute lg:px-[20px] w-full h-full transition-opacity duration-700 ease-in-out ${
          ...
          >
            ...
            <div className="relative w-full h-full flex items-center justify-center  sm:px-8 md:px-20 lg:px-[200px]">
              <Card
                style={{ backgroundColor: "rgba(255, 255, 255, 0)" }}
                className="relative flex items-center justify-center w-full h-full card-no-border card-no-radius"
              >
                {/* Image */}
                <div className="relative flex-shrink-0 w-full h-full sm:w-full sm:h-full md:w-full md:h-full lg:w-[400px] lg:h-[500px] p-0 flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center lg:hidden backdrop-blur-md">
                    <h1
                      style={{ color: item.txtcolor1 }}
                      className="text-[18px] sm:text-[24px] font-extralight p-4"
                    >
                      Why Choose Bagani Blades?
                    </h1>
                    <h1
                      style={{ color: item.txtcolor1 }}
                      className="text-[36px] sm:text-[48px] font-bold leading-tight mt-5 px-[30px] lg:px-0"
                    >
                      {item.quote}
                    </h1>
                    <h2
                      style={{ color: item.txtcolor1 }}
                      className="font-extralight text-[16px] sm:text-[20px]"
                    >
                      {item.content}
                    </h2>
                  </div>
                ...
                <div className="flex-col p-4 hidden lg:flex">
                  <h1
                    ...
                    className="text-[18px] sm:text-[24px] lg:text-[25px] font-extralight"
                  >
                    Why Choose Bagani Blades?
                  </h1>
                  <h1
                    style={{ color: item.txtcolor }}
                    className="text-[36px] sm:text-[48px] lg:text-[60px] font-bold leading-tight mt-5"
                  >
                    {item.quote}
                  </h1>
                  <h2
                    style={{ color: item.txtcolor }}
                    className="font-extralight text-[16px] sm:text-[20px] lg:text-[20px]"
                  >
                    {item.content}
                  </h2>
                </div>
